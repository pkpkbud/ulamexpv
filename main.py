...
def _zestawienie():
    ...
    if typ_pv == 1 and uklad_pv == 1:
        result += (
            ...
            f"<tr><td>S.1<td>ŚRUBA M12<td>{58 * ilosc_kons}<td>DIN-933-TZN-8.8<td>35"
            f"<tr><td>S.2<td>NAKRĘTKA M12<td>{58 * ilosc_kons}<td>DIN-6923-TZN-8<td>-"
            f"<tr><td>S.3<td>PODKŁADKA D13<td>{116 * ilosc_kons}<td>DIN-9021-TZN-200HV<td>-"
        ...
        result += (
            ...
            f"<tr><td>S.1<td>ŚRUBA M12<td>{52 * ilosc_kons}<td>DIN-933-TZN-8.8<td>35"
            f"<tr><td>S.2<td>NAKRĘTKA M12<td>{52 * ilosc_kons}<td>DIN-6923-TZN-8<td>-"
            f"<tr><td>S.3<td>PODKŁADKA D13<td>{104 * ilosc_kons}<td>DIN-9021-TZN-200HV<td>-"
            f"<tr><td>S.4<td>ŚRUBA M16<td>{4 * ilosc_kons}<td>DIN-933-TZN-8.8<td>40"
            f"<tr><td>S.5<td>NAKRĘTKA M16<td>{4 * ilosc_kons}<td>DIN-6923-TZN-8<td>-"
            f"<tr><td>S.6<td>PODKŁADKA D17<td>{8 * ilosc_kons}<td>DIN-9021-TZN-200HV<td>-"
        )
